...
const guides: Guide[] = [
  {
    ...
    category: 'Steel Path',
    content: {
      es: `<h3>Introducción ⚔️</h3>
El Camino de Acero es el contenido "endgame" de Warframe, ofreciendo versiones mucho más difíciles de todas las misiones del mapa estelar, con enemigos con niveles incrementados (+100) y defensas mejoradas. A cambio, obtendrás Esencia de Acero, que se puede usar para comprar objetos valiosos de Teshin.
...
Prepárate para enemigos significativamente más fuertes, con +150% de salud, armadura y escudos.
...
¡Mucha suerte, Tenno!`,
      en: `<h3>Introduction ⚔️</h3>
The Steel Path is Warframe's "endgame" content, offering much harder versions of all missions on the star chart, with enemies having increased levels (+100) and enhanced defenses. In return, you'll get Steel Essence, which can be used to buy valuable items from Teshin.
...
<h3>Once Unlocked 💥</h3>
Be prepared for significantly stronger enemies, with +150% health, armor, and shields.
...
Good luck, Tenno!`,
  ...
  },
  {
    ...
    category: 'Beginners',
    content: {
      es: `<h3>¡Tus Primeros Pasos en el Sistema Origen! 🚀</h3>
Warframe puede ser abrumador al principio, ¡pero esta guía te ayudará a empezar con el pie derecho!

<h3>1. Elige tu Primer Warframe 🤖</h3>
Al empezar, elegirás entre Excalibur, Mag y Volt.
<ul class="list-disc pl-5 space-y-2 my-4">
...
No te preocupes, ¡podrás conseguir todos más adelante!
...
Tu objetivo principal es desbloquear todos los planetas. Completa todos los nodos de una región para acceder a la siguiente a través de los Cruces. ¡Los cruces dan recompensas muy importantes!

<h3>3. El Poder de los Mods 🃏</h3>
El verdadero poder en Warframe viene de los <b>Mods</b>.
<ul class="list-disc pl-5 space-y-2 my-4">
...
Usa tus 50 Platinum iniciales para comprar <b>ranuras de Warframe y de armas</b>. ¡Son cruciales para expandir tu arsenal! No compres armas o Warframes directamente.

<h3>5. Únete a un Clan 🤝</h3>
Los clanes te dan acceso a planos exclusivos de armas y Warframes en su <b>Dojo</b>. Además, ¡es la mejor forma de encontrar compañeros de escuadrón!

<h3>6. Completa las Aventuras (Quests) 🎬</h3>
Warframe tiene una historia increíble. Sigue las aventuras principales para desbloquear contenido crucial y entender el lore del juego. ¡"El Segundo Sueño" y "La Guerra Interna" te volarán la cabeza!

¡Disfruta tu viaje, Tenno!`,
      en: `<h3>Your First Steps in the Origin System! 🚀</h3>
Warframe can be overwhelming at first, but this guide will help you get started on the right foot!

<h3>1. Choose Your First Warframe 🤖</h3>
When you start, you'll choose between Excalibur, Mag, and Volt.
<ul class="list-disc pl-5 space-y-2 my-4">
...
Don't worry, you can get them all later!
...
Your main goal is to unlock all the planets. Complete all the nodes in a region to access the next one through the Junctions. Junctions give very important rewards!

<h3>3. The Power of Mods 🃏</h3>
The real power in Warframe comes from <b>Mods</b>.
<ul class="list-disc pl-5 space-y-2 my-4">
...
Use your initial 50 Platinum to buy <b>Warframe and weapon slots</b>. They are crucial to expand your arsenal! Do not buy weapons or Warframes directly.

<h3>5. Join a Clan 🤝</h3>
Clans give you access to exclusive weapon and Warframe blueprints in their <b>Dojo</b>. Plus, it's the best way to find squadmates!

<h3>6. Complete the Quests 🎬</h3>
Warframe has an incredible story. Follow the main quests to unlock crucial content and understand the game's lore. "The Second Dream" and "The War Within" will blow your mind!
