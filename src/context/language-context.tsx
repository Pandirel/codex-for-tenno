...
const textContent = {
  es: {
    ...
    giveaway: {
      ...
      add: 'Añadir',
      reset: 'Reiniciar',
      addParticipantErrorTitle: 'Error',
      addParticipantError: 'El participante ya existe.',
      addParticipantsPrompt: 'Añade participantes para empezar el sorteo.',
      spinErrorTitle: 'No hay suficientes participantes',
      spinError: 'Se necesitan al menos 2 participantes para girar la ruleta.',
    },
    footer: {
  ...
  en: {
    ...
    giveaway: {
      ...
      reset: 'Reset',
      addParticipantErrorTitle: 'Error',
      addParticipantError: 'Participant already exists.',
      addParticipantsPrompt: 'Add participants to start the giveaway.',
      spinErrorTitle: 'Not enough participants',
      spinError: 'You need at least 2 participants to spin the wheel.',
    },
    footer: {
