...
const textContent = {
  es: {
    ...
    giveaways: {
      ...
      description: '¡Participa en el sorteo de la comunidad!',
      prize: 'Premio Actual',
      ...
      noWinner: '¡Gira la ruleta para encontrar un ganador!',
      addParticipantError: 'Por favor ingresa un nombre para el participante.',
      participantExistsError: 'Este participante ya existe.',
    },
    footer: {
  ...
  en: {
    ...
    giveaways: {
      ...
      description: 'Join the community giveaway!',
      prize: 'Current Prize',
      ...
      noWinner: 'Spin the wheel to find a winner!',
      addParticipantError: 'Please enter a name for the participant.',
      participantExistsError: 'This participant already exists.',
    },
    footer: {
