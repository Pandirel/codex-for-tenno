...
export default function GiveawayPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="container flex h-16 max-w-screen-2xl items-center justify-between">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold font-headline tracking-tight hidden md:block">Codex for Tenno</h1>
              <h1 className="text-2xl font-bold font-headline tracking-tight md:hidden">CfT</h1>
            </div>
            <MainNav />
          </div>
      ...
      <main className="container mx-auto max-w-screen-2xl p-4 sm:p-6 md:p-8 flex-grow flex flex-col">
        <GiveawayRoulette />
      </main>
